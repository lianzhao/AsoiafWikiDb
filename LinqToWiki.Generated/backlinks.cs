...
// Type: LinqToWiki.Generated.Entities.backlinksSelect
...
namespace LinqToWiki.Generated.Entities
{
  public sealed class backlinksSelect
  {
    ...
    {
      backlinksSelect backlinksSelect = new backlinksSelect();
      XAttribute xattribute1 = element.Attribute((XName) "pageid");
      if (xattribute1 != null && xattribute1.Value != "")
        backlinksSelect.pageid = ValueParser.ParseInt64(xattribute1.Value);
      XAttribute xattribute2 = element.Attribute((XName) "ns");
      if (xattribute2 != null && xattribute2.Value != "")
        backlinksSelect.ns = ValueParser.ParseNamespace(xattribute2.Value, wiki);
      XAttribute xattribute3 = element.Attribute((XName) "title");
      if (xattribute3 != null)
        backlinksSelect.title = ValueParser.ParseString(xattribute3.Value);
      XAttribute xattribute4 = element.Attribute((XName) "redirect");
      if (xattribute4 != null)
        backlinksSelect.redirect = ValueParser.ParseBoolean(xattribute4.Value);
      return backlinksSelect;
    }
