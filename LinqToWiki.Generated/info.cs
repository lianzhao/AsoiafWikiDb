...
namespace LinqToWiki.Generated.Entities
{
  public sealed class infoResult
  {
    ...
    {
      return string.Format("pageid: {0}; ns: {1}; title: {2}; missing: {3}; invalid: {4}; special: {5}; touched: {6}; lastrevid: {7}; counter: {8}; length: {9}; redirect: {10}; new: {11}; starttimestamp: {12}; contentmodel: {13}; edittoken: {14}; deletetoken: {15}; protecttoken: {16}; movetoken: {17}; blocktoken: {18}; unblocktoken: {19}; emailtoken: {20}; importtoken: {21}; watchtoken: {22}; watched: {23}; watchers: {24}; notificationtimestamp: {25}; talkid: {26}; subjectid: {27}; fullurl: {28}; editurl: {29}; readable: {30}; preload: {31}; displaytitle: {32}", (object) this.pageid, (object) this.ns, (object) this.title, (object) (bool) (this.missing ? 1 : 0), (object) (bool) (this.invalid ? 1 : 0), (object) (bool) (this.special ? 1 : 0), (object) this.touched, (object) this.lastrevid, (object) this.counter, (object) this.length, (object) (bool) (this.redirect ? 1 : 0), (object) (bool) (this.@new ? 1 : 0), (object) this.starttimestamp, (object) this.contentmodel, (object) this.edittoken, (object) this.deletetoken, (object) this.protecttoken, (object) this.movetoken, (object) this.blocktoken, (object) this.unblocktoken, (object) this.emailtoken, (object) this.importtoken, (object) this.watchtoken, (object) (bool) (this.watched ? 1 : 0), (object) this.watchers, (object) this.notificationtimestamp, (object) this.talkid, (object) this.subjectid, (object) this.fullurl, (object) this.editurl, (object) (bool) (this.readable ? 1 : 0), (object) this.preload, (object) this.displaytitle);
    }
  }
}
