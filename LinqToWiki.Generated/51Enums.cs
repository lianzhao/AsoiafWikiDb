...
// Type: LinqToWiki.Generated.revisionscontentformat
...
namespace LinqToWiki.Generated
{
  public sealed class revisionscontentformat : StringValue
  {
    ...
    public static readonly revisionscontentformat application_json = new revisionscontentformat("application/json");

    internal revisionscontentformat(string value)
      : base(value)
    {
    }
