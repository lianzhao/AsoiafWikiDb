...
// Type: LinqToWiki.Generated.Entities.alllinksSelect
...
namespace LinqToWiki.Generated.Entities
{
  public sealed class alllinksSelect
  {
    ...
    {
      alllinksSelect alllinksSelect = new alllinksSelect();
      XAttribute xattribute1 = element.Attribute((XName) "fromid");
      if (xattribute1 != null && xattribute1.Value != "")
        alllinksSelect.fromid = ValueParser.ParseInt64(xattribute1.Value);
      XAttribute xattribute2 = element.Attribute((XName) "ns");
      if (xattribute2 != null && xattribute2.Value != "")
        alllinksSelect.ns = ValueParser.ParseNamespace(xattribute2.Value, wiki);
      XAttribute xattribute3 = element.Attribute((XName) "title");
      if (xattribute3 != null)
        alllinksSelect.title = ValueParser.ParseString(xattribute3.Value);
      return alllinksSelect;
    }
